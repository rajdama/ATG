...
function Header_content({ windowWidth }) {
    ...
    return (
        <header className="p-3 bg-white  text-secondary">
            ...
            <div className={`container post"  ${(windowWidth > 1280 ? "show" : "hidden")}`}>
                <div className={"d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start "}>
                    ...
                    <div className="text-end">
                        ...
                        <button type="button" className="btn btn-primary">Leave group</button>
                    </div>
                </div>
            </div>
            <div className={`  ${(windowWidth < 1280 ? "show" : "hidden")}`}>
                <div style={{ display: "flex", justifyContent: "space-between" }} >
                    <a href="#" className="nav-link px-2 text-dark">All posts(32)</a>
